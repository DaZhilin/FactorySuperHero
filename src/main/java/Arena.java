public class Arena {
    ...
    /**
     * Создание третей переменной со случайным числом от 0-100, которая в процессе поможет опеределить победителя
     */
    private int c = (int) (Math.random()*100);

    public Arena(Object[] hero) {
        if (a == b)
            System.out.println("В этот раз судьба решила не испытвать силы нашего героя. Попробуйте повторно" );
        else
